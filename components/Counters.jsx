...
export default function GlobalOpportunitiesCounter() {
  ...
  return (
    <div className="relative">
      ...
      {/* STICKY SECTION */}
      <section className="sticky top-0 h-screen flex items-center bg-[#050f24] overflow-hidden">
        ...
        <div ref={ref} className="relative max-w-7xl mx-auto px-6 w-full">
          ...
          >
            ...
            <p className="text-white/60 mt-2 text-xs max-w-xl mx-auto">
              Scroll-triggered live analytics from real international placements.
            </p>
          </motion.div>
            ...
            <div className="md:col-span-5">
              <div className="h-full rounded-2xl p-5 border border-white/10 bg-white/5 backdrop-blur-xl relative overflow-hidden">
                ...
                <p className="text-white/60 text-xs mt-2 leading-relaxed">
                  Direct access to universities, employers, and training institutions
